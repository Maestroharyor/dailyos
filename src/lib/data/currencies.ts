// ISO 4217 circulating currencies with display symbols. Used by searchable
// currency pickers. `symbol` falls back to the code where no distinct glyph.
...
// Primary issuing country (ISO 3166-1 alpha-2) for each currency, used to
// pre-fill the country when a currency is picked. Multi-country / shared
// currencies (EUR, XAF, XOF, XCD, XPF, ANG, AWG) are intentionally omitted so
// the country isn't guessed wrongly.
export const CURRENCY_PRIMARY_COUNTRY: Record<string, string> = {
  AED: "AE", AFN: "AF", ALL: "AL", AMD: "AM", AOA: "AO", ARS: "AR", AUD: "AU",
  AZN: "AZ", BAM: "BA", BBD: "BB", BDT: "BD", BGN: "BG", BHD: "BH", BIF: "BI",
  BND: "BN", BOB: "BO", BRL: "BR", BSD: "BS", BTN: "BT", BWP: "BW", BYN: "BY",
  BZD: "BZ", CAD: "CA", CDF: "CD", CHF: "CH", CLP: "CL", CNY: "CN", COP: "CO",
  CRC: "CR", CUP: "CU", CVE: "CV", CZK: "CZ", DJF: "DJ", DKK: "DK", DOP: "DO",
  DZD: "DZ", EGP: "EG", ERN: "ER", ETB: "ET", FJD: "FJ", GBP: "GB", GEL: "GE",
  GHS: "GH", GMD: "GM", GNF: "GN", GTQ: "GT", GYD: "GY", HNL: "HN", HRK: "HR",
  HTG: "HT", HUF: "HU", IDR: "ID", ILS: "IL", INR: "IN", IQD: "IQ", IRR: "IR",
  ISK: "IS", JMD: "JM", JOD: "JO", JPY: "JP", KES: "KE", KGS: "KG", KHR: "KH",
  KMF: "KM", KRW: "KR", KWD: "KW", KZT: "KZ", LAK: "LA", LBP: "LB", LKR: "LK",
  LRD: "LR", LSL: "LS", LYD: "LY", MAD: "MA", MDL: "MD", MGA: "MG", MKD: "MK",
  MMK: "MM", MNT: "MN", MRU: "MR", MUR: "MU", MVR: "MV", MWK: "MW", MXN: "MX",
  ...
  SAR: "SA", SBD: "SB", SCR: "SC", SDG: "SD", SEK: "SE", SGD: "SG", SLE: "SL",
  ...
  VES: "VE", VND: "VN", VUV: "VU", WST: "WS", YER: "YE", ZAR: "ZA", ZMW: "ZM",
  ZWL: "ZW",
};
