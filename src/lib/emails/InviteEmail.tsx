...
export const InviteEmail = ({
  ...
  return (
    ...
    >
      <EmailText>
        {inviterName} invited you to join <strong>{spaceName}</strong> on DailyOS as{" "}
        <strong>{role}</strong>.
      </EmailText>
      <EmailText>Accept the invitation to set up your account and start collaborating.</EmailText>
