...
/**
 * Mirrors the real customer detail layout: back button, round avatar, name and
 * subtitle, then a 4-up stat row, the order list and the sidebar cards.
 *
 * The page used to render a bare "Loading..." in a card, which had no
 * relationship to what arrived and made every load look like an empty state.
 */
